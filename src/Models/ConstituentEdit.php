 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ConstituentEdit implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConstituentEdit';
...
self::RECEIPT_TYPE_CONSOLIDATED_RECEIPTS,        ];
     ...
     * Sets last
     *
     * @param string $last The constituent's last name. For individuals only. Character limit: 100.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name If the constituent's <code>type</code> is <i>Individual</i>, this is a computed field that does not apply to edit operations. If the <code>type</code> is <i>Organization</i>, this field cannot be changed to null and represents the organization's name. Character limit: 60.
     *
     * @return $this
     */
