 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EmailAddressEdit implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EmailAddressEdit';
...
'type' => 'getType'    ];
     ...
     * Sets address
     *
     * @param string $address The email address. This property cannot be set to null.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type The type of email address. Available values are the entries in the <a href=\"https://developer.sky.blackbaud.com/docs/services/56b76470069a0509c8f1c5b3/operations/ListEmailAddressTypes\"><b>Phone Types</b></a> table. This property cannot be set to null.
     *
     * @return $this
     */
