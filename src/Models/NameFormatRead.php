 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NameFormatRead implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NameFormatRead';
...
'type' => 'getType'    ];
     ...
     * Sets id
     *
     * @param string $id The immutable system record ID of the name format.
     *
     * @return $this
     */
     ...
     *
     * @param string $configuration_id The name format configuration identifier.
     *
     * @return $this
     */
     ...
     * Sets formatted_name
     *
     * @param string $formatted_name The name format formatted name.
     *
     * @return $this
     */
