 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddressAdd implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AddressAdd';
...
'region' => 'getRegion'    ];
     ...
     * Sets city
     *
     * @param string $city The city of the address.  Do not use in combination with the <code>suburb</code> property. Character limit: 50.
     *
     * @return $this
     */
     ...
     * Sets suburb
     *
     * @param string $suburb The suburb of the address. Do not use in combination with the <code>city</code> property.
     *
     * @return $this
     */
