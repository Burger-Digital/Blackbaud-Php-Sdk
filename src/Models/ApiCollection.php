 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApiCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApiCollection';
...
'value' => 'getValue'    ];
     ...
     * Sets value
     *
     * @param object[] $value The result set of items after applying any request parameters. To facilitate paging, this may be a subset of all available items.
     *
     * @return $this
     */
