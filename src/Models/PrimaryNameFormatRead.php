 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PrimaryNameFormatRead implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PrimaryNameFormatRead';
...
self::PRIMARY_TYPE_SALUTATION,        ];
     ...
     * Sets id
     *
     * @param string $id The immutable system record ID of the primary name format.
     *
     * @return $this
     */
     ...
     *
     * @param string $configuration_id The primary name format configuration identifier.
     *
     * @return $this
     */
     ...
     * Sets custom_format
     *
     * @param bool $custom_format Whether the primary name format uses a custom format.
     *
     * @return $this
     */
     ...
     * Sets formatted_name
     *
     * @param string $formatted_name The primary name format formatted name.
     *
     * @return $this
     */
     ...
     * Sets primary_type
     *
     * @param string $primary_type The primary name format primary type.
     *
     * @return $this
     */
