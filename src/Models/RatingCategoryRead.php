 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RatingCategoryRead implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RatingCategoryRead';
...
self::TYPE_UNKNOWN,        ];
     ...
     * Sets inactive
     *
     * @param bool $inactive Indicates whether the category is inactive.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The name of the rating category.
     *
     * @return $this
     */
     ...
     * Sets source_name
     *
     * @param string $source_name The source of the category.*
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type Gets or sets the type of the rating category.
     *
     * @return $this
     */
