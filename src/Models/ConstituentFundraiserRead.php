 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ConstituentFundraiserRead implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConstituentFundraiserRead';
...
'type' => 'getType'    ];
     ...
     * Sets constituent_id
     *
     * @param string $constituent_id The immutable system record ID of the fundraiser.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type The type of fundraiser. Available values are the entries in the <b>Solicitor Type</b> table.
     *
     * @return $this
     */
