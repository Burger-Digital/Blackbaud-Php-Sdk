 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddressEdit implements ModelInterface, ArrayAccess
{
...
'region' => 'getRegion'    ];
     ...
     * Sets country
     *
     * @param string $country The country of the address, can be the country's ID, name, or abbreviation.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type The address type. Available values are the entries in the <a href=\"https://developer.sky.blackbaud.com/docs/services/56b76470069a0509c8f1c5b3/operations/ListAddressTypes\"><b>Address Types</b></a> table. This property cannot be set to null.
     *
     * @return $this
     */
     ...
     * Sets region
     *
     * @param string $region The region for the address.
     *
     * @return $this
     */
