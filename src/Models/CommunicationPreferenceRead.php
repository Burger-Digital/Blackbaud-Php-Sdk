 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CommunicationPreferenceRead implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CommunicationPreferenceRead';
...
'start' => 'getStart'    ];
     ...
     * Sets id
     *
     * @param string $id The immutable system record ID of the communication preference.
     *
     * @return $this
     */
