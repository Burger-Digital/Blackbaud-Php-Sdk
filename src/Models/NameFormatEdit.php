 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NameFormatEdit implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NameFormatEdit';
...
'type' => 'getType'    ];
     ...
     * Sets custom_format
     *
     * @param bool $custom_format Whether the name format uses a custom format.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type The name format type. Available values are the entries in the <a href=\"https://developer.sky.blackbaud.com/docs/services/56b76470069a0509c8f1c5b3/operations/ListNameFormatTypes\"><b>Addr/Sal Types</b></a> table. This value cannot be set to null.
     *
     * @return $this
     */
