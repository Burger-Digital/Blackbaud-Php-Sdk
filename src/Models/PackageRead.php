 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PackageRead implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PackageRead';
...
'description' => 'getDescription'    ];
     ...
     * Sets id
     *
     * @param string $id The immutable system record ID of the package.
     *
     * @return $this
     */
