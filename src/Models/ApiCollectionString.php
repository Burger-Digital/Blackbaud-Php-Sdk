 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApiCollectionString implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApiCollection[String]';
...
'value' => 'getValue'    ];
     ...
     * Sets value
     *
     * @param string[] $value The set of items included in the response. This may be a subset of the items in the collection.
     *
     * @return $this
     */
