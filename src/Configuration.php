...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.sky.blackbaud.com/constituent/v1';
     ...
     * @var string
     */
    protected $userAgent = 'Blackbaud Php Sdk 1.0.0';
    ...
    {
        $report  = 'PHP SDK (BurgerDigital\BlackbaudPhpSdk) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api.sky.blackbaud.com/constituent/v1",
