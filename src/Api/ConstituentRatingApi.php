...
class ConstituentRatingApi
{
    ...
    public function createConstituentRatingRequest($rating_add = null)
    {
        ...
        if (isset($rating_add)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($rating_add));
            } else {
                $httpBody = $rating_add;
            }
    ...
    public function editConstituentRatingRequest($rating_id, $rating_edit = null)
    {
        ...
        if (isset($rating_edit)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($rating_edit));
            } else {
