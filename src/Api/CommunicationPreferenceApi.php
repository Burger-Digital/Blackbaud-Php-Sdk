...
class CommunicationPreferenceApi
{
     ...
     *
     * @param  \BurgerDigital\BlackbaudPhpSdk\BurgerDigital\BlackbaudPhpSdk\Models\CommunicationPreferenceAdd $body An object that represents the communication preference to create. (optional)
     *
     ...
     */
    public function createConstituentCommunicationPreference($body = null)
    {
        list($response) = $this->createConstituentCommunicationPreferenceWithHttpInfo($body);
        return $response;
    }
     ...
     */
    public function createConstituentCommunicationPreferenceWithHttpInfo($body = null)
    {
        $returnType = '\BurgerDigital\BlackbaudPhpSdk\BurgerDigital\BlackbaudPhpSdk\Models\PostResponse';
        $request = $this->createConstituentCommunicationPreferenceRequest($body);
     ...
     */
    public function createConstituentCommunicationPreferenceAsync($body = null)
    {
        return $this->createConstituentCommunicationPreferenceAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createConstituentCommunicationPreferenceAsyncWithHttpInfo($body = null)
    {
        $returnType = '\BurgerDigital\BlackbaudPhpSdk\BurgerDigital\BlackbaudPhpSdk\Models\PostResponse';
        $request = $this->createConstituentCommunicationPreferenceRequest($body);
     ...
     */
    protected function createConstituentCommunicationPreferenceRequest($body = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteConstituentCommunicationPreferenceRequest($communication_preference_id)
    {
     ...
     * @param  \BurgerDigital\BlackbaudPhpSdk\BurgerDigital\BlackbaudPhpSdk\Models\CommunicationPreferenceEdit $body An object that represents the properties of the communication preference to edit. (optional)
     *
     * @throws \BurgerDigital\BlackbaudPhpSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function editConstituentCommunicationPreference($communication_preference_id, $body = null)
    {
        $this->editConstituentCommunicationPreferenceWithHttpInfo($communication_preference_id, $body);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function editConstituentCommunicationPreferenceWithHttpInfo($communication_preference_id, $body = null)
    {
        $returnType = '';
        $request = $this->editConstituentCommunicationPreferenceRequest($communication_preference_id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function editConstituentCommunicationPreferenceAsync($communication_preference_id, $body = null)
    {
        return $this->editConstituentCommunicationPreferenceAsyncWithHttpInfo($communication_preference_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function editConstituentCommunicationPreferenceAsyncWithHttpInfo($communication_preference_id, $body = null)
    {
        $returnType = '';
        $request = $this->editConstituentCommunicationPreferenceRequest($communication_preference_id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function editConstituentCommunicationPreferenceRequest($communication_preference_id, $body = null)
    {
        // verify the required parameter 'communication_preference_id' is set
        if ($communication_preference_id === null || (is_array($communication_preference_id) && count($communication_preference_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listCommunicationPreferencesRequest()
    {
     ...
     * @throws \BurgerDigital\BlackbaudPhpSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BurgerDigital\BlackbaudPhpSdk\BurgerDigital\BlackbaudPhpSdk\Models\ApiCollectionCommunicationPreferenceRead
     */
     ...
     * @throws \BurgerDigital\BlackbaudPhpSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BurgerDigital\BlackbaudPhpSdk\BurgerDigital\BlackbaudPhpSdk\Models\ApiCollectionCommunicationPreferenceRead, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BurgerDigital\BlackbaudPhpSdk\BurgerDigital\BlackbaudPhpSdk\Models\ApiCollectionCommunicationPreferenceRead';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BurgerDigital\BlackbaudPhpSdk\BurgerDigital\BlackbaudPhpSdk\Models\ApiCollectionCommunicationPreferenceRead',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listConstituentCommunicationPreferencesSingleConstituentRequest($constituent_id, $limit = null, $offset = null)
    {
