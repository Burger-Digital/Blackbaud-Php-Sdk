...
class ConstituentRelationshipApi
{
    ...
    public function createConstituentRelationshipRequest($relationship_add = null)
    {
        ...
        if (isset($relationship_add)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($relationship_add));
            } else {
    ...
    public function editConstituentRelationshipRequest($relationship_id, $relationship_edit = null)
    {
        ...
        if (isset($relationship_edit)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($relationship_edit));
            } else {
