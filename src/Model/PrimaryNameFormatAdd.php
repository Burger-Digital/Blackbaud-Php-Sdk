 ...
 */
class PrimaryNameFormatAdd implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PrimaryNameFormatAdd';
     ...
     *
     * @param string|null $configuration_id The primary name format configuration identifier. Required when custom_format is false.
     *
     * @return self
     */
     ...
     * Sets custom_format
     *
     * @param bool|null $custom_format Whether the primary name format uses a custom format. Defaults to false.
     *
     * @return self
     */
     ...
     * Sets formatted_name
     *
     * @param string|null $formatted_name The primary name format formatted name. Required when custom_format is true. Character limit: 255.
     *
     * @return self
     */
    public function setFormattedName($formatted_name)
    {
        if (!is_null($formatted_name) && (mb_strlen($formatted_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $formatted_name when calling PrimaryNameFormatAdd., must be smaller than or equal to 255.');
        }
        if (!is_null($formatted_name) && (mb_strlen($formatted_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $formatted_name when calling PrimaryNameFormatAdd., must be bigger than or equal to 0.');
        }
