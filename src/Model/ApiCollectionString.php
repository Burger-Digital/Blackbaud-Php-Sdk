...
/**
 * ApiCollectionString Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiCollectionString implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiCollection[String]';
     ...
     * Sets value
     *
     * @param string[]|null $value The set of items included in the response. This may be a subset of the items in the collection.
     *
     * @return self
     */
