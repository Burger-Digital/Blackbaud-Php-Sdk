...
class AddressEdit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setAddressLines($address_lines)
    {
        if (!is_null($address_lines) && (mb_strlen($address_lines) > 150)) {
            throw new \InvalidArgumentException('invalid length for $address_lines when calling AddressEdit., must be smaller than or equal to 150.');
        }
        if (!is_null($address_lines) && (mb_strlen($address_lines) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address_lines when calling AddressEdit., must be bigger than or equal to 0.');
        }
     ...
     * Sets city
     *
     * @param string|null $city The city of the address. Character limit: 50.
     *
     * @return self
     */
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 50)) {
            throw new \InvalidArgumentException('invalid length for $city when calling AddressEdit., must be smaller than or equal to 50.');
        }
        if (!is_null($city) && (mb_strlen($city) < 0)) {
            throw new \InvalidArgumentException('invalid length for $city when calling AddressEdit., must be bigger than or equal to 0.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        if (!is_null($postal_code) && (mb_strlen($postal_code) > 12)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling AddressEdit., must be smaller than or equal to 12.');
        }
        if (!is_null($postal_code) && (mb_strlen($postal_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling AddressEdit., must be bigger than or equal to 0.');
        }
     ...
     * Sets type
     *
     * @param string|null $type The address type. Available values are the entries in the <a href=\"https://developer.sky.blackbaud.com/docs/services/56b76470069a0509c8f1c5b3/operations/ListAddressTypes\"><b>Address Types</b></a> table. This property cannot be set to null.
     *
     * @return self
     */
    ...
    public function setCart($cart)
    {
        if (!is_null($cart) && (mb_strlen($cart) > 20)) {
            throw new \InvalidArgumentException('invalid length for $cart when calling AddressEdit., must be smaller than or equal to 20.');
        }
        if (!is_null($cart) && (mb_strlen($cart) < 0)) {
            throw new \InvalidArgumentException('invalid length for $cart when calling AddressEdit., must be bigger than or equal to 0.');
        }
    ...
    public function setDpc($dpc)
    {
        if (!is_null($dpc) && (mb_strlen($dpc) > 8)) {
            throw new \InvalidArgumentException('invalid length for $dpc when calling AddressEdit., must be smaller than or equal to 8.');
        }
        if (!is_null($dpc) && (mb_strlen($dpc) < 0)) {
            throw new \InvalidArgumentException('invalid length for $dpc when calling AddressEdit., must be bigger than or equal to 0.');
        }
