...
class PhoneEdit implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets number
     *
     * @param string|null $number The phone number. This property cannot be set to null.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The phone type. Available values are the entries in the <a href=\"https://developer.sky.blackbaud.com/docs/services/56b76470069a0509c8f1c5b3/operations/ListPhoneTypes\"><b>Phone Types</b></a> table. This property cannot be set to null.
     *
     * @return self
     */
