...
/**
 * ConstituentFundraiserRead Class Doc Comment
 *
 * @category Class
 ...
 */
class ConstituentFundraiserRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConstituentFundraiserRead';
     ...
     * Sets constituent_id
     *
     * @param string|null $constituent_id The immutable system record ID of the fundraiser.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of fundraiser. Available values are the entries in the <b>Solicitor Type</b> table.
     *
     * @return self
     */
