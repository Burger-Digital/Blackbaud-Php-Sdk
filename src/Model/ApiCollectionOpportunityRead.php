...
/**
 * ApiCollectionOpportunityRead Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiCollectionOpportunityRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiCollection[OpportunityRead]';
    ...
    protected static $openAPITypes = [
        'count' => 'int',
        'next_link' => 'string',
        'value' => '\BurgerDigital\BlackbaudPhpSdk\Model\OpportunityRead[]'
    ];
     ...
     * Gets value
     *
     * @return \BurgerDigital\BlackbaudPhpSdk\Model\OpportunityRead[]|null
     */
     ...
     * Sets value
     *
     * @param \BurgerDigital\BlackbaudPhpSdk\Model\OpportunityRead[]|null $value The set of items included in the response. This may be a subset of the items in the collection.
     *
     * @return self
     */
