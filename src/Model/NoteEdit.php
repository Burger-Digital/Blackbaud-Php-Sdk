 ...
 */
class NoteEdit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NoteEdit';
    ...
    public function setSummary($summary)
    {
        if (!is_null($summary) && (mb_strlen($summary) > 50)) {
            throw new \InvalidArgumentException('invalid length for $summary when calling NoteEdit., must be smaller than or equal to 50.');
        }
        if (!is_null($summary) && (mb_strlen($summary) < 0)) {
            throw new \InvalidArgumentException('invalid length for $summary when calling NoteEdit., must be bigger than or equal to 0.');
        }
     ...
     * Sets type
     *
     * @param string|null $type The note type. Available values are the entries in the <a href=\"https://developer.sky.blackbaud.com/docs/services/56b76470069a0509c8f1c5b3/operations/ListNoteTypes\"><b>Notepad Types</b></a> table. This property cannot be set to null.
     *
     * @return self
     */
