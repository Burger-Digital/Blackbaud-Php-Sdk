 ...
 */
class ActionAdd implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActionAdd';
    ...
    public function setSummary($summary)
    {
        if (!is_null($summary) && (mb_strlen($summary) > 255)) {
            throw new \InvalidArgumentException('invalid length for $summary when calling ActionAdd., must be smaller than or equal to 255.');
        }
        if (!is_null($summary) && (mb_strlen($summary) < 0)) {
            throw new \InvalidArgumentException('invalid length for $summary when calling ActionAdd., must be bigger than or equal to 0.');
        }
