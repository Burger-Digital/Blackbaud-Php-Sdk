 ...
 */
class PackageRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PackageRead';
     ...
     * Sets id
     *
     * @param string|null $id The immutable system record ID of the package.
     *
     * @return self
     */
