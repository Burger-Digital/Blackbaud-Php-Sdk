 ...
 */
class RatingEdit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RatingEdit';
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling RatingEdit., must be smaller than or equal to 255.');
        }
        if (!is_null($comment) && (mb_strlen($comment) < 0)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling RatingEdit., must be bigger than or equal to 0.');
        }
     ...
     * Sets date
     *
     * @param \DateTime|null $date The date of the rating. Uses <a href=\"https://tools.ietf.org/html/rfc3339\">ISO-8601 format: </a><i>1969-11-21T10:29:43</i>. This property cannot be set to null.
     *
     * @return self
     */
