...
/**
 * ApiCollection Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiCollection';
     ...
     * Sets value
     *
     * @param object[]|null $value The result set of items after applying any request parameters. To facilitate paging, this may be a subset of all available items.
     *
     * @return self
     */
