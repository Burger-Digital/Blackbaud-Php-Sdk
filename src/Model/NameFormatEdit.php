...
/**
 * NameFormatEdit Class Doc Comment
 *
 * @category Class
 ...
 */
class NameFormatEdit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NameFormatEdit';
    ...
    public function setFormattedName($formatted_name)
    {
        if (!is_null($formatted_name) && (mb_strlen($formatted_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $formatted_name when calling NameFormatEdit., must be smaller than or equal to 255.');
        }
        if (!is_null($formatted_name) && (mb_strlen($formatted_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $formatted_name when calling NameFormatEdit., must be bigger than or equal to 0.');
        }
     ...
     * Sets type
     *
     * @param string|null $type The name format type. Available values are the entries in the <a href=\"https://developer.sky.blackbaud.com/docs/services/56b76470069a0509c8f1c5b3/operations/ListNameFormatTypes\"><b>Addr/Sal Types</b></a> table. This value cannot be set to null.
     *
     * @return self
     */
