 ...
 */
class ActionRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActionRead';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['computed_status'] = $data['computed_status'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['computed_status']) && !in_array($this->container['computed_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'computed_status', must be one of '%s'",
                $this->container['computed_status'],
     ...
     * Sets id
     *
     * @param string|null $id The immutable system record ID of the action.
     *
     * @return self
     */
     ...
     * Sets category
     *
     * @param string|null $category The channel or intent of the constituent interaction. Available values are <i>Phone Call</i>, <i>Meeting</i>, <i>Mailing</i>, <i>Email</i>, and <i>Task/Other</i>.
     *
     * @return self
     */
     ...
     *
     * @param string|null $computed_status The computed action status. If the system is not configured to use custom action statuses, this field computes the status based on the <code>completed</code> and <code>date</code> properties. If not, the field calculates the status based on the action's date property and whether action's <code>Action Status</code> property is configured as completed.
     *
     * @return self
     */
     ...
     * Sets constituent_id
     *
     * @param string|null $constituent_id The immutable system record ID of the constituent associated with the action.
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param \DateTime|null $date The action date. Uses <a href=\"https://tools.ietf.org/html/rfc3339\">ISO-8601 format: </a><i>1969-11-21T10:29:43</i>.
     *
     * @return self
     */
     ...
     * Sets date_added
     *
     * @param \DateTime|null $date_added The date when the action was created. Includes an offset from UTC in <a href=\"https://tools.ietf.org/html/rfc3339\">ISO-8601 format: </a><i>1969-11-21T10:29:43-04:00</i>.
     *
     * @return self
     */
     ...
     * Sets date_modified
     *
     * @param \DateTime|null $date_modified The date when the action was last modified. Includes an offset from UTC in <a href=\"https://tools.ietf.org/html/rfc3339\">ISO-8601 format: </a><i>1969-11-21T10:29:43-04:00</i>.
     *
     * @return self
     */
     ...
     * Sets status_code
     *
     * @param string|null $status_code The action status code. Available values are in the <a href=\"https://developer.sky.blackbaud.com/docs/services/56b76470069a0509c8f1c5b3/operations/ListActionStatusTypes\"><b>Action Status</b></a> table. This property is only returned when the system is configured to use custom action statuses.
     *
     * @return self
     */
     ...
     * Sets summary
     *
     * @param string|null $summary The short description of the action that appears at the top of the record.
     *
     * @return self
     */
