...
/**
 * NameFormatRead Class Doc Comment
 *
 * @category Class
 ...
 */
class NameFormatRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NameFormatRead';
     ...
     * Sets id
     *
     * @param string|null $id The immutable system record ID of the name format.
     *
     * @return self
     */
     ...
     *
     * @param string|null $configuration_id The name format configuration identifier.
     *
     * @return self
     */
     ...
     * Sets constituent_id
     *
     * @param string|null $constituent_id The immutable system record ID of the constituent associated with the name format.
     *
     * @return self
     */
     ...
     * Sets formatted_name
     *
     * @param string|null $formatted_name The name format formatted name.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The name format type. Available values are the entries in the <a href=\"https://developer.sky.blackbaud.com/docs/services/56b76470069a0509c8f1c5b3/operations/ListNameFormatTypes\"><b>Addr/Sal Types</b></a> table.
     *
     * @return self
     */
