 ...
 */
class Fundraiser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Fundraiser';
    ...
    protected static $openAPITypes = [
        ...
        'credit_amount' => '\BurgerDigital\BlackbaudPhpSdk\Model\Currency'
    ];
     ...
     * Sets constituent_id
     *
     * @param string|null $constituent_id The immutable system record ID of the constituent associated with the fundraiser.
     *
     * @return self
     */
     ...
     * Sets credit_amount
     *
     * @param \BurgerDigital\BlackbaudPhpSdk\Model\Currency|null $credit_amount credit_amount
     *
     * @return self
     */
