 ...
 */
class ProfilePictureRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProfilePictureRead';
     ...
     * Sets constituent_id
     *
     * @param string|null $constituent_id The immutable system record ID of the constituent associated with the profile picture.
     *
     * @return self
     */
     ...
     * Sets thumbnail_url
     *
     * @param string|null $thumbnail_url The URL for a thumbnail of the profile picture. Contains a time-bound signature that limits access to 60 minutes.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url The URL for the profile picture. The URL contains a time-bound signature that limits access to 60 minutes.
     *
     * @return self
     */
