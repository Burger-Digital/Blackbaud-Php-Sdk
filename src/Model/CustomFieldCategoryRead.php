 ...
 */
class CustomFieldCategoryRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomFieldCategoryRead';
     ...
     * Sets name
     *
     * @param string|null $name The name of the custom field category.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of data that custom fields with this category represent. Available values are listed below.
     *
     * @return self
     */
