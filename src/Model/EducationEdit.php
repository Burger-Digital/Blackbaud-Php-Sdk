 ...
 */
class EducationEdit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EducationEdit';
    ...
    public function setCampus($campus)
    {
        if (!is_null($campus) && (mb_strlen($campus) > 50)) {
            throw new \InvalidArgumentException('invalid length for $campus when calling EducationEdit., must be smaller than or equal to 50.');
        }
        if (!is_null($campus) && (mb_strlen($campus) < 0)) {
            throw new \InvalidArgumentException('invalid length for $campus when calling EducationEdit., must be bigger than or equal to 0.');
        }
    ...
    public function setKnownName($known_name)
    {
        if (!is_null($known_name) && (mb_strlen($known_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $known_name when calling EducationEdit., must be smaller than or equal to 50.');
        }
        if (!is_null($known_name) && (mb_strlen($known_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $known_name when calling EducationEdit., must be bigger than or equal to 0.');
        }
    ...
    public function setRegistrationNumber($registration_number)
    {
        if (!is_null($registration_number) && (mb_strlen($registration_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $registration_number when calling EducationEdit., must be smaller than or equal to 50.');
        }
        if (!is_null($registration_number) && (mb_strlen($registration_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $registration_number when calling EducationEdit., must be bigger than or equal to 0.');
        }
    ...
    public function setSocialOrganization($social_organization)
    {
        if (!is_null($social_organization) && (mb_strlen($social_organization) > 50)) {
            throw new \InvalidArgumentException('invalid length for $social_organization when calling EducationEdit., must be smaller than or equal to 50.');
        }
        if (!is_null($social_organization) && (mb_strlen($social_organization) < 0)) {
            throw new \InvalidArgumentException('invalid length for $social_organization when calling EducationEdit., must be bigger than or equal to 0.');
        }
