 ...
 */
class ConstituentAddressAdd implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConstituentAddressAdd';
    ...
    public function setAddressLines($address_lines)
    {
        if (!is_null($address_lines) && (mb_strlen($address_lines) > 150)) {
            throw new \InvalidArgumentException('invalid length for $address_lines when calling ConstituentAddressAdd., must be smaller than or equal to 150.');
        }
        if (!is_null($address_lines) && (mb_strlen($address_lines) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address_lines when calling ConstituentAddressAdd., must be bigger than or equal to 0.');
        }
    ...
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 50)) {
            throw new \InvalidArgumentException('invalid length for $city when calling ConstituentAddressAdd., must be smaller than or equal to 50.');
        }
        if (!is_null($city) && (mb_strlen($city) < 0)) {
            throw new \InvalidArgumentException('invalid length for $city when calling ConstituentAddressAdd., must be bigger than or equal to 0.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        if (!is_null($postal_code) && (mb_strlen($postal_code) > 12)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling ConstituentAddressAdd., must be smaller than or equal to 12.');
        }
        if (!is_null($postal_code) && (mb_strlen($postal_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling ConstituentAddressAdd., must be bigger than or equal to 0.');
        }
