 ...
 */
class ConstituentAdd implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConstituentAdd';
    ...
    protected static $openAPITypes = [
        'address' => '\BurgerDigital\BlackbaudPhpSdk\Model\ConstituentAddressAdd',
        'birthdate' => '\BurgerDigital\BlackbaudPhpSdk\Model\FuzzyDate',
        'deceased' => 'bool',
        'deceased_date' => '\BurgerDigital\BlackbaudPhpSdk\Model\FuzzyDate',
        'email' => '\BurgerDigital\BlackbaudPhpSdk\Model\ConstituentEmailAddressAdd',
        'first' => 'string',
        'former_name' => 'string',
        'gender' => 'string',
        ...
        'middle' => 'string',
        'name' => 'string',
        'online_presence' => '\BurgerDigital\BlackbaudPhpSdk\Model\ConstituentOnlinePresenceAdd',
        'phone' => '\BurgerDigital\BlackbaudPhpSdk\Model\ConstituentPhoneAdd',
     ...
     * Gets address
     *
     * @return \BurgerDigital\BlackbaudPhpSdk\Model\ConstituentAddressAdd|null
     */
     ...
     * Sets address
     *
     * @param \BurgerDigital\BlackbaudPhpSdk\Model\ConstituentAddressAdd|null $address address
     *
     * @return self
     */
     ...
     * Gets email
     *
     * @return \BurgerDigital\BlackbaudPhpSdk\Model\ConstituentEmailAddressAdd|null
     */
     ...
     * Sets email
     *
     * @param \BurgerDigital\BlackbaudPhpSdk\Model\ConstituentEmailAddressAdd|null $email email
     *
     * @return self
     */
    ...
    public function setFirst($first)
    {
        if (!is_null($first) && (mb_strlen($first) > 50)) {
            throw new \InvalidArgumentException('invalid length for $first when calling ConstituentAdd., must be smaller than or equal to 50.');
        }
        if (!is_null($first) && (mb_strlen($first) < 0)) {
            throw new \InvalidArgumentException('invalid length for $first when calling ConstituentAdd., must be bigger than or equal to 0.');
        }
    ...
    public function setFormerName($former_name)
    {
        if (!is_null($former_name) && (mb_strlen($former_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $former_name when calling ConstituentAdd., must be smaller than or equal to 100.');
        }
        if (!is_null($former_name) && (mb_strlen($former_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $former_name when calling ConstituentAdd., must be bigger than or equal to 0.');
        }
    ...
    public function setLast($last)
    {
        if (!is_null($last) && (mb_strlen($last) > 100)) {
            throw new \InvalidArgumentException('invalid length for $last when calling ConstituentAdd., must be smaller than or equal to 100.');
        }
        if (!is_null($last) && (mb_strlen($last) < 0)) {
            throw new \InvalidArgumentException('invalid length for $last when calling ConstituentAdd., must be bigger than or equal to 0.');
        }
    ...
    public function setMiddle($middle)
    {
        if (!is_null($middle) && (mb_strlen($middle) > 50)) {
            throw new \InvalidArgumentException('invalid length for $middle when calling ConstituentAdd., must be smaller than or equal to 50.');
        }
        if (!is_null($middle) && (mb_strlen($middle) < 0)) {
            throw new \InvalidArgumentException('invalid length for $middle when calling ConstituentAdd., must be bigger than or equal to 0.');
        }
     ...
     *
     * @return \BurgerDigital\BlackbaudPhpSdk\Model\ConstituentOnlinePresenceAdd|null
     */
     ...
     *
     * @param \BurgerDigital\BlackbaudPhpSdk\Model\ConstituentOnlinePresenceAdd|null $online_presence online_presence
     *
     * @return self
     */
     ...
     * Gets phone
     *
     * @return \BurgerDigital\BlackbaudPhpSdk\Model\ConstituentPhoneAdd|null
     */
     ...
     * Sets phone
     *
     * @param \BurgerDigital\BlackbaudPhpSdk\Model\ConstituentPhoneAdd|null $phone phone
     *
     * @return self
     */
    ...
    public function setPreferredName($preferred_name)
    {
        if (!is_null($preferred_name) && (mb_strlen($preferred_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $preferred_name when calling ConstituentAdd., must be smaller than or equal to 50.');
        }
        if (!is_null($preferred_name) && (mb_strlen($preferred_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $preferred_name when calling ConstituentAdd., must be bigger than or equal to 0.');
        }
     ...
     * Sets date_added
     *
     * @param \DateTime|null $date_added Optional.  The date the constituent was added. Useful when importing records from another system and the source system has a date added. Uses <a href=\"https://tools.ietf.org/html/rfc3339\">ISO-8601 format: </a><i>1969-11-21T10:29:43</i>.
     *
     * @return self
     */
