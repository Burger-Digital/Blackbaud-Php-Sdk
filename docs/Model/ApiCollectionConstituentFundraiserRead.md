...
**value** | [**\BurgerDigital\BlackbaudPhpSdk\Model\ConstituentFundraiserRead[]**](ConstituentFundraiserRead.md) | The set of items included in the response. This may be a subset of the items in the collection. | [optional]
