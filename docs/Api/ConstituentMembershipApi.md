...
> \BurgerDigital\BlackbaudPhpSdk\BurgerDigital\BlackbaudPhpSdk\Models\ApiCollectionMembershipRead listConstituentMembershipsSingleConstituent($constituent_id)
...
$apiInstance = new BurgerDigital\BlackbaudPhpSdk\BurgerDigital\BlackbaudPhpSdk\Api\ConstituentMembershipApi(
...
[**\BurgerDigital\BlackbaudPhpSdk\BurgerDigital\BlackbaudPhpSdk\Models\ApiCollectionMembershipRead**](../Model/ApiCollectionMembershipRead.md)
...
# **listMemberships**
> \BurgerDigital\BlackbaudPhpSdk\BurgerDigital\BlackbaudPhpSdk\Models\ApiCollectionMembershipRead listMemberships($date_added, $last_modified, $sort_token, $limit, $offset)
