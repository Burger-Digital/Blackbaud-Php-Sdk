...
```php
getConstituentProspectStatus($constituent_id): \BurgerDigital\BlackbaudPhpSdk\Model\ProspectStatusRead
```
...
$apiInstance = new BurgerDigital\BlackbaudPhpSdk\Api\ProspectStatusApi(
...
[**\BurgerDigital\BlackbaudPhpSdk\Model\ProspectStatusRead**](../Model/ProspectStatusRead.md)
